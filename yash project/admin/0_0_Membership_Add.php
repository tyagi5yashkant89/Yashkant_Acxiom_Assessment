                    ...
                    <div class="card-body" style="height: 500px">
                        ...
                        <form method="post" style="width:800px">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="contactname" class="form-control" id="inputcontactname">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="inputcontactaddress" class="col-sm-2 col-form-label">Contact Address</label>
                                <div class="col-sm-10">
                                    <input type="contactaddress" class="form-control" id="inputcontactaddress">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="inputaadharcardno" class="col-sm-2 col-form-label">Aadhar Card No.</label>
                                <div class="col-sm-10">
                                    <input type="aadharcardno" class="form-control" id="inputaadharcardno">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <label for="inputenddate" class="col-sm-2 col-form-label">Membership</label>
                                <div class="col-sm-10">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="inlineRadio1" value="option1">
                                        <label class="form-check-label" for="inlineRadio1">Six Months</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="inlineRadio2" value="option2">
                                        <label class="form-check-label" for="inlineRadio2">One Year</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="inlineRadio3" value="option3">
                                        <label class="form-check-label" for="inlineRadio3">Two Years</label>
                                    </div>
                                </div>
                                <div class="row ">
                                    <div class="col-5">
