                ...
                <div class="card">
                    ...
                    <div class="card-body" style="height: 500px">
                        ...
                        <form method="post" style="width:800px">
                            <div class="row mb-3">
                                <label for="inputmembershipnumber" class="col-sm-2 col-form-label">Membership Number</label>
                                <div class="col-sm-10">
                                    <input type="membership number" class="form-control" id="inputmembershipnumber">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <label for="inputenddate" class="col-sm-2 col-form-label">Membership Extension</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label for="inputenddate" class="col-sm-2 col-form-label">Membership Remove</label>
                                <div class="col-sm-10">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
